...
class ChatbotWindow(QMainWindow):
    def __init__(self):
        ...
        # Implement the enter function of keyboard.
    ...
    def send_message(self):
        ...
        # Use append method to append the user input in the chat area.
        self.chat_area.append(
            f"<p style='color:#333333'>Me: {user_input}</p>")
        self.input_field.clear()  # Clear input field.

        # Use threading for program efficiency.
        thread = threading.Thread(target=self.get_bot_response,
                                  args=(user_input,))
        thread.start()

    def get_bot_response(self, user_input):
        # Get response and append it in the chat area with gray background.
